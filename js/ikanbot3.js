var rule = {
    ...
    filterable: 1,
    filter_url: '{{fl.tag}}',
    图片来源: '@Referer=https://www.aikanbot.com/@User-Agent=Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/119.0.0.0 Safari/537.36',
    filter: {
        "movie": [{
            "key": "tag",
            "name": "标签",
