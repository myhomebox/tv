var rule = {
	    ...
	    class_url:'1&2&29&30',
            ...
            lazy: '',
            limit: 6,
            推荐: 'ul.vodlist_wi.clearfix;li;a&&title;a&&data-original;.pic_text&&Text;a&&href',
            double: true, // 推荐内容是否双层定位
            一级:'ul.vodlist_wi.clearfix li;a&&title;a&&data-original;.pic_text&&Text;a&&href',
            二级: {
                "title": "h1&&Text;li.data:eq(0)&&Text",
                "img": ".vodlist_thumb .lazyload&&data-original",
            ...
            搜索: '.searchlist_item;a&&title;.lazyload&&data-original;.pic_text&&Text;a&&href',
}
