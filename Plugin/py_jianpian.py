...
class Spider(Spider):
    ...
    def init(self, extend):
        ...
        self.headers = {
            ...
            "User-Agent": "Mozilla/5.0 (Linux; Android 9; V2196A Build/PQ3A.190705.08211809; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/91.0.4472.114 Mobile Safari/537.36",
    ...
    def homeVideoContent(self):
        a = []
        try:
            res = requests.get(url=self.home_url + '/api/crumb/list?fcate_pid=unknownbe2a5c4162bb5528&category_id=0&area=0&year=0&limit=24&channel=wandoujia&page=1&sort=hot&type=0', headers=self.headers)
    ...
    def categoryContent(self, cid, page, filter, ext):
        a = []
        try:
            res = requests.get(url=self.home_url + f'/api/crumb/list?fcate_pid=unknownbe2a5c4162bb5528&category_id={cid}&area=0&year=0&limit=24&channel=wandoujia&page={page}&sort=hot&type=0',
