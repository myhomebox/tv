...
class Spider(Spider):
    ...
    def homeVideoContent(self):
        a = []
        try:
            res = requests.get(url=self.home_url + '/api/crumb/list?fcate_pid=0&category_id=5&area=0&year=0&limit=24&channel=wandoujia&page=1&sort=hot&type=0', headers=self.headers)
